...
**Metrics Webapp** is a single page application. Users can view different available cities and their specific details. 
...
- [Live Demo Link](https://metrics-webapp-49wz.onrender.com/)
...
```sh
  git clone https://github.com/MAleemH/React-Capstone-Project.git
```
...
Original design idea by [Nelson Sakwa on Behance](https://www.behance.net/sakwadesignstudio). And the license to use is [Creative Commons license of the design](https://creativecommons.org/licenses/by-nc/4.0/).
